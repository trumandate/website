...
> = {
  ...
  ar: {
    strategy: {
      ...
      lede: "يمكن لكل جهة بناء شجرة أهداف واضحة، بينما يربط ترو ماندات (TruMandate) مؤشرات الأداء بالأهداف والمبادرات، من خلال تحديد خط الأساس والهدف والمسؤول عن تحقيقه والقيمة الفعلية بشكل مستمر، بما يضمن ارتباط كل مؤشر بالهدف الذي يدعمه والمبادرات التي تسهم في تحقيقه.",
      fragmentCaption:
      ...
      argument: {
        ...
        points: [
          ...
          {
            eyebrow: "حلقة الوصل",
            body: "في ترو ماندات (TruMandate)، لا يأتي مؤشر الأداء الرئيسي (KPI) كعنصر منفصل في نهاية العملية، بل يشكل حلقة الوصل بين الأهداف والمبادرات. فعند تغيير نطاق أي مبادرة، يظهر أثر التغيير مباشرةً على مؤشر الأداء المرتبط بها، لأن العلاقة بينهما مدمجة ضمن سجل المؤشر نفسه.",
          },
          {
            eyebrow: "الرفض",
    ...
    execution: {
      ...
      headlineTail: ".",
      heroHeadlineMaxCh: 24,
      lede: "لا يمكن لأدوات إدارة المشاريع ربط نتائجها بتكليف لا تعرفه. ويربط ترو ماندات (TruMandate) كل مبادرة بالهدف الذي موّلها، بحيث يُحتسب أي تأخير كتراجع مباشر في تحقيق الهدف، ويظهر أثره في يوم حدوثه.",
      fragmentCaption:
    ...
    benefits: {
      ...
      headlineTail: "؟",
      heroHeadlineMaxCh: 22,
      lede: "تُقدَّر الفوائد المستقبلية عندما يُكافأ التفاؤل، ثم تُقاس بعد مغادرة الفريق. ويحافظ ترو ماندات (TruMandate) على متابعة كل فائدة لمدة 24 شهرًا بعد إغلاق المشروع، مع ربطها مباشرةً بمؤشر الأداء الرئيسي (KPI) المحدد الذي وعد المشروع بتحسينه.",
      fragmentCaption:
      ...
      argument: {
        ...
        points: [
          ...
          },
          {
            ...
            body: "يواصل ترو ماندات (TruMandate) متابعة الفائدة لمدة 24 شهرًا بعد إغلاق المشروع، مع بقاء المسؤول عنها في منصبه، وقياسها مقابل مؤشر الأداء الرئيسي (KPI) الذي كان المشروع يستهدف تحسينه. وخلال هذه الفترة، التي غالبًا ما تتراجع فيها المتابعة، يواصل ترو ماندات رصد تحقق الفائدة.",
          },
        ],
      },
      ai: {
