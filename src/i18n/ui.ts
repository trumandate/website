  ...
  ar: {
    ...
    home: {
      hero: {
        ...
        headlineTail: "",
        lede: "الاستراتيجية هي وعد. والتنفيذ هو الدليل. تحافظ منصة ترو مانديت على استمرارية الصلة بينهما، ويقوم الذكاء الاصطناعي الخاص بها بتحليل كل تفاصيلها بدقة.",
    ...
    meta: {
      ...
      home: {
        ...
        description:
          "الاستراتيجية هي وعد. والتنفيذ هو الدليل. تحافظ منصة ترو مانديت على استمرارية الصلة بينهما، ويقوم الذكاء الاصطناعي الخاص بها بتحليل كل تفاصيلها بدقة.",
      },
      contact: {
