...
export const ui: UiDictionary = {
  ...
  ar: {
    ...
    footer: {
      ...
      poweredBySuffix: " – دبي، الإمارات العربية المتحدة",
    ...
    home: {
      hero: {
        ...
        headlineLead: "ربط كل توجيه بأثر إيجابي ",
        headlineGradient: "قابل للقياس",
        headlineTail: "",
        lede: "الاستراتيجية هي وعد. والتنفيذ هو الدليل. تحافظ منصة ترو ماندات على استمرارية الصلة بينهما، ويقوم الذكاء الاصطناعي الخاص بها بتحليل كل تفاصيلها بدقة.",
        boardCaption: "استعراض جزئي لمركز القيادة، يليه عرض شامل للمركز.",
      },
      proof: {
        stat1Label: "مشروعًا خاضعًا للحوكمة",
        stat2Label: "ميزانية المحفظة",
        stat3Label: "قرارات بانتظار المراجعة",
        stat4Label: "الفوائد المقاسة بعد الإغلاق",
        stat4UnitAr: "شهراً",
      },
      aiQueue: {
        eyebrow: "الذكاء الاصطناعي في المنصة",
        heading: "الذكاء الاصطناعي يقترح، والمسؤول يقرر، والسجل يوثّق.",
        ...
        card1Title: "الاعتمادية المشتركة بين الإدارات معرضة للخطر",
        card1Detail:
          "تأخرت البوابة 3 ضمن المبادرة 07، مما يؤثر على شرط بدء المبادرة 21، ولم يبادر أيٌّ من المسؤولين إلى تصعيد الأمر.",
        card1Log: "مقبول · m.alfarsi · 08:15",
        card2Badge: "مراقبة ذكية · الاستراتيجية",
        card2Title: "مؤشران يقيسان منفعة واحدة",
        card2Detail:
          "يرتبط الهدفان 2.1 و4.3 بالمقياس نفسه ومجموعة مبادرات متداخلة، ما يستدعي دمجهما أو تحديد أحدهما كهدف مساهم.",
        card2Log: "معدَّل · h.alsuwaidi · 11:07",
        card3Badge: "مراقبة ذكية · المنافع",
        card3Title: "تسرّب المنافع بعد الإغلاق",
        card3Detail:
          "بعد مرور ربعين على إغلاق المشروع، تقلّ منفعة 4.2 عن التوقعات بنسبة 18%، وقد توقّف مؤشر الأداء عن التحسن بعد انتهاء مهمة الفريق.",
        card3Log: "مفتوح · مُسند إلى s.alnuaimi",
        auditLine: "لا يُدرج أي مخرج للنموذج في السجل إلا بعد اعتماده.",
      },
      chain: {
        eyebrow: "قابلية التتبع",
        heading: "هوية موحّدة تربط بين التفويض والتمويل عبر كامل مسار التنفيذ.",
        sub: "يرتبط الهدف نفسه عبر كامل مسار التنفيذ، بدءًا من القرار الذي وقّعه الوزير ووصولًا إلى الوفر المالي الذي يمكن للجهة المالية إثباته.",
        record1Name: "الهدف",
        record1Kicker: "01 · الهدف",
        record1Title: "نضج الحكومة الرقمية",
        record1Body: "له إصدار معتمد، ومنشور، ومُرجّح، مع تحديد المسؤول عنه.",
        ...
        record2Title: "اعتماد الخدمات الرقمية",
        record2Body: "مرتبط بالهدف 1.2، دون خط أساس أو مؤشر أداء رئيسي.",
        record2Row1Label: "خط الأساس ← المستهدف",
        record2Row1Value: "42.0 → 75.0",
        record2Row2Label: "القيمة الفعلية",
        record2Row2Value: "61.4",
        ...
        record4Title: "البوابة 4 – إخراج الأنظمة من الخدمة",
        record4Body: "يُحتسب أي تأخير كخصم في الأداء، ويظهر أثره في يوم حدوثه.",
        ...
        record5Title: "الوفر التشغيلي السنوي",
        record5Body:
      ...
      withoutRecord: {
        eyebrow: "بدون السجل",
        heading: "تُكتب الاستراتيجية مرة واحدة، ثم يُعاد إدخالها مرارًا على مدار العام.",
        col1Figure: "3 أيام",
        col1Label: "التخطيط",
        col1Body:
          "لتحديد مساهمة كل مبادرة في تحقيق الأهداف، تُجمع البيانات يدويًا في جداول البيانات، إن توفرت.",
        col2Figure: "نهاية الشهر",
        col2Label: "التنفيذ",
        col2Body:
          "قبل أن يصل التأخير إلى الجهة المموِّلة، يكون الرقم قد تم تقريبه بالفعل من قِبل الشخص المسؤول عنه، والذي سيُطلب منه تفسيره لاحقًا.",
        col3Figure: "أبداً",
        col3Label: "المنافع",
        col3Body:
          "تُقاس المنفعة بعد إغلاق المشروع مقارنةً بالتوقعات، رغم انتهاء مهمة الفريق المسؤول عن تحقيقها قبل موعد استحقاقها.",
      },
      // UNCHANGED — still backs SuggestionCard.astro's product-page
      ...
      closingCta: {
        ...
        heading: "اختر هدفًا واحدًا، وسنتتبّع مساره حتى نصل إلى العائد المالي الذي حققه.",
        body: "أربعون دقيقة لتحليل محفظة أعمال مماثلة لمحفظتك، تشمل إداراتك وفترتك الزمنية وأسماء متخذي القرارات، وليست بيانات تجريبية.",
        secondaryLabel: "راسلنا بدلاً من ذلك",
        essentialsEyebrow: "الأساسيات",
        row1Label: "النشر",
        row1Body: "حل سيادي يعمل داخل مقرّكم أو ضمن بيئة سحابية مخصصة لكم، مع بقاء جميع البيانات والعمليات داخل نطاقكم.",
        row2Label: "اللغة",
        row2Body: "تجربة متكاملة باللغتين العربية والإنجليزية، بما في ذلك جميع التقارير.",
        row3Label: "تديره",
    ...
    fragment: {
      ...
      initiativeRows: {
        ...
        row1Name: "البوابة الموحدة للخدمات",
    ...
    contact: {
      ...
      interestLegend: "ما الذي ترغب في الاطلاع عليه",
      interestOption1: "عرض كامل للمنصة",
      interestOption2: "تسلسل الاستراتيجية ومؤشرات الأداء",
      interestOption3: "تحقيق الفوائد",
    ...
    meta: {
      ...
      // `contact.heading` ("قارنها بخطتك الخاصة.") suffixed "— TruMandate";
      ...
      home: {
        ...
        description:
          "الاستراتيجية هي وعد. والتنفيذ هو الدليل. تحافظ منصة ترو ماندات على استمرارية الصلة بينهما، ويقوم الذكاء الاصطناعي الخاص بها بتحليل كل تفاصيلها بدقة.",
      },
      contact: {
      ...
      ogImageAlt:
        "شعار TruMandate وعنوان 'ربط كل توجيه بأثر إيجابي قابل للقياس' على خلفية خضراء داكنة.",
    },
    // Blog section — written directly in Arabic (BUILD_FLAGS: "written, not
    // machine-translated"), matching the English side one-for-one.
    blog: {
      eyebrow: "من الفريق الذي يقف وراء TruMandate",
      heading: "ملاحظات حول حوكمة المحافظ",
      sub: "محتوى موجز ومحدد حول حوكمة المحافظ، وتنفيذ الاستراتيجيات، وتحقيق الفوائد، يقدمه أعضاء الفريق الذين يطوّرون المنصة.",
      ...
      ctaBody:
        "أربعون دقيقة لتحليل محفظة أعمال مماثلة لمحفظتك، تشمل إداراتك وفترتك الزمنية وأسماء متخذي القرارات، وليست بيانات تجريبية.",
